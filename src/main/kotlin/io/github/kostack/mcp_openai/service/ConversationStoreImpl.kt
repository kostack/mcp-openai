...
class ConversationStoreImpl : ConversationStore {
  ...
  override suspend fun appendOnce(
    sessionId: String,
    itemId: String?,
    item: Map<String, Any>
  ) {
  ...
  override suspend fun history(sessionId: String): List<Map<String, Any>> = sessions[sessionId] ?: emptyList()
